...
export default function InteractivePortrait() {
  ...
  useEffect(() => {
    ...
    const baseTexture = textureLoader.load("/images/anamay-profile.png", (texture) => {
    ...
    const helmetTexture = textureLoader.load("/images/anamay-profile.png")
  ...
  return (
    ...
    >
      <div className="absolute bottom-6 left-6 z-10 pointer-events-none opacity-40">
        <span className="text-[10px] font-mono text-lorenzo-accent uppercase tracking-[0.2em]">
          Interactive Profile // System.v3
        </span>
      </div>
    </div>
  )
