          ...
          >
            <div className="relative">
              ...
              >
                ...
                <a href="https://github.com/Flamechargerr" aria-label="GitHub Profile" target="_blank" rel="noopener noreferrer" className="w-10 h-10 flex items-center justify-center border border-lorenzo-accent/30 text-lorenzo-accent hover:bg-lorenzo-accent hover:text-lorenzo-dark transition-all">
                ...
                <a href="https://linkedin.com/in/anamay-tripathy" aria-label="LinkedIn Profile" target="_blank" rel="noopener noreferrer" className="w-10 h-10 flex items-center justify-center border border-lorenzo-accent/30 text-lorenzo-accent hover:bg-lorenzo-accent hover:text-lorenzo-dark transition-all">
