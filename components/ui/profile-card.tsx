...
export default function ProfileCard({ data }: ProfileCardProps) {
  ...
  const handleViewProfile = () => {
    confetti({
      ...
      spread: 70,
      origin: { y: 0.6 },
      colors: ["#06b6d4", "#0ea5e9", "#a855f7", "#ec4899"],
    })
    setIsModalOpen(true)
  }
          ...
          <div className="relative z-10 flex flex-col items-center justify-between h-full p-8">
            <div className="relative">
              ...
              <motion.img
                ...
                alt={data.username}
                className="relative w-48 h-48 rounded-full object-cover border-4 border-gray-700 group-hover:border-cyan-500 transition-colors duration-300 cursor-pointer"
