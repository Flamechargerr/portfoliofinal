...
const achievements: Achievement[] = [
    {
        ...
        event: "Johns Hopkins University",
        date: "2024",
        description: "Advanced methods in regression, classification, clustering, and neural network applications.",
        type: "certification",
        icon: "🧠",
    ...
    {
        id: 2,
        title: "IBM GenAI & LLMs",
        event: "Professional Specialization",
        date: "2025",
        description: "Prompt engineering, conversational agents, RAG architectures, and fine-tuning LLMs.",
        type: "certification",
        icon: "🤖",
    ...
    },
    {
        ...
        date: "2024",
        description: "Comprehensive data visualization, SQL query optimization, and statistical modeling with Python.",
        type: "certification",
        icon: "📊",
    ...
    },
    {
        ...
        event: "Google Certification",
        date: "2025",
        description: "Structuring prompt scripts, context control, and AI API workflow integrations.",
        type: "certification",
        icon: "💬",
    ...
    },
    {
        ...
        event: "Indian School of Business (ISB)",
        date: "2024",
        description: "Budgeting, portfolio risk modeling, cash flow forecasting, and financial analysis.",
        type: "certification",
        icon: "💵",
    ...
    {
        id: 6,
        title: "J.P. Morgan Quant Research",
        event: "Forage Virtual Experience",
        date: "2026",
        description: "Completed simulation modeling natural gas prices, storage contracts, and Logistic Regression credit risk modeling.",
        type: "certification",
        icon: "📈",
    ...
    {
        id: 7,
        title: "Mastercard Consulting",
        event: "Forage Virtual Experience",
        date: "2026",
        description: "Simulation for credit card product design, strategy, and business analyst consulting workflows.",
        type: "certification",
        icon: "🎯",
    ...
    },
    {
        ...
        date: "2026",
        description: "Solved 250+ coding problems focusing on dynamic programming, graphs, trees, and binary search.",
        type: "award",
        position: "Achieved",
        icon: "🌟",
    ...
    },
    {
        ...
        event: "E-Cell MIT Manipal",
        date: "2024 - 2025",
        description: "Led development of the MES 2025 summit website, managing event-day digital infrastructure with zero downtime.",
        type: "award",
        position: "Leadership",
        icon: "🚀",
